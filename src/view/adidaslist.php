...
<head>
    ...
    <title>Danh sách sản phẩm Adidas</title>
</head>
<body background="../../img/background/das-backgound.png">
<div class="topnav">
    <a style="color: white;width: 100px" class="active">
        <img style="width: 70%" src="../../img/login-logo/logo-adidas.png"></a>
    <a class="btn active" href="../../index.php">Trang chủ</a>
    <a class="btn" href="../view/nikelist.php">Nike</a>
</div>
<div class="container">
    <h3 class="h3">    </h3>
    <div class="row">
